...
Приложение доступно по адресу: http://194.58.126.39:5001/

## 📋 Описание

REST API на Python с использованием стандартной библиотеки `http.server`. При каждом push в ветку `main` автоматически:
...
| **http.server** | Встроенный HTTP-сервер (BaseHTTPRequestHandler) |
